...
module ZiptasticTestRunner
  ...
  def self.env_override(m)
    live = getenv("ZIPTASTIC_TEST_LIVE")
    override = getenv("ZIPTASTIC_TEST_OVERRIDE")
    ...
    explain = getenv("ZIPTASTIC_TEST_EXPLAIN")
    m["ZIPTASTIC_TEST_EXPLAIN"] = explain if explain && !explain.empty?
...
Runner = ZiptasticTestRunner
Helpers = ZiptasticHelpers
Vs = VoxgigStruct
