...
require_relative 'Ziptastic_types'
...
class ZiptasticSDK
  ...
  def initialize(options = {})
    ...
    feature_opts = ZiptasticHelpers.to_map(VoxgigStruct.getprop(@options, "feature"))
    if feature_opts
      featureorder = VoxgigStruct.getpath(@options, "__derived__.featureorder")
      if featureorder.is_a?(Array)
        featureorder.each do |fname|
          fopts = ZiptasticHelpers.to_map(feature_opts[fname])
          if fopts && fopts["active"] == true
            utility.feature_add.call(@_rootctx, ZiptasticFeatures.make_feature(fname))
          end
        end
      end
    end
  ...
  def get_utility
    ZiptasticUtility.copy(@_utility)
  end
  ...
  def prepare(fetchargs = {})
    ...
    ctrl = ZiptasticHelpers.to_map(VoxgigStruct.getprop(fetchargs, "ctrl")) || {}
    ...
    params = ZiptasticHelpers.to_map(VoxgigStruct.getprop(fetchargs, "params")) || {}
    query = ZiptasticHelpers.to_map(VoxgigStruct.getprop(fetchargs, "query")) || {}
  ...
  def raw_request(fetchargs = {})
    ...
    if fetched.is_a?(Hash)
      status = ZiptasticHelpers.to_int(VoxgigStruct.getprop(fetched, "status"))
  ...
  def graphql(query, variables = nil, ctrl = nil)
    ...
    if errors.is_a?(Array) && !errors.empty?
      ...
      res["ok"] = false
      res["err"] = ZiptasticError.new(
        "graphql_error", "ZiptasticSDK: graphql: #{msg}")
      res["graphql"] = errors
    end
