...
type Args struct {
	Entity string         `json:"entity" jsonschema:"get_location_by_zipcode"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.ZiptasticSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "ziptastic_list",
		Description: "List records from Ziptastic. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "ziptastic_load",
		Description: "Load a single record from Ziptastic. " +
...
func runOp(client *sdk.ZiptasticSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.ZiptasticSDK, name string) (sdk.ZiptasticEntity, error) {
	switch strings.ToLower(name) {
	case "get_location_by_zipcode":
		return client.GetLocationByZipcode(nil), nil
