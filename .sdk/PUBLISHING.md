...
|---|---|---|
| `ts/` | @voxgig-sdk/ziptastic-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/ziptastic-sdk \
      --repository voxgig-sdk/ziptastic-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/ziptastic-sdk` shows it, and
`npm trust revoke @voxgig-sdk/ziptastic-sdk --id=<id>` removes it.
