...
class PrimaryUtilityTest < Minitest::Test
  ...
  def setup
    @runner = ZiptasticOmni.make_runner(TEST_JSON_FILE, ZiptasticSDK.test(nil, nil))
  ...
  def test_make_point_basic
    ...
    subject = lambda do |ctx|
      ...
      err.nil? ? point : ZiptasticOmni.errify(err)
    end
