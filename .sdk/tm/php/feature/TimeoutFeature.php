...
class ZiptasticTimeoutFeature extends ZiptasticBaseFeature
{
    ...
    private function _with_timeout(ZiptasticContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(ZiptasticContext $_ctx, float $ms): void
    {
        $client = $this->client;
