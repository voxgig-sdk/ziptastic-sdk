...
class ZiptasticProxyFeature extends ZiptasticBaseFeature
{
    ...
    public function init(ZiptasticContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (ZiptasticContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
