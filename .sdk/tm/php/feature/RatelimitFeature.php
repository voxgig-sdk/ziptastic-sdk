...
// Ziptastic SDK ratelimit feature
...
class ZiptasticRatelimitFeature extends ZiptasticBaseFeature
{
    ...
    private function _acquire(ZiptasticContext $ctx): void
    {
    ...
    private function _track(ZiptasticContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
