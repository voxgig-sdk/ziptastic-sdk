...
class ZiptasticMakeRequest
{
    public static function call(ZiptasticContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new ZiptasticResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new ZiptasticResponse($fetched);
        } else {
