...
class ZiptasticGraphql
{
    ...
    // equivalent.
    public static function body(ZiptasticContext $ctx): mixed
    {
    ...
    public static function errors(ZiptasticContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
