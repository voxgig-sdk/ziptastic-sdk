...
// Ziptastic SDK utility: fetcher

class ZiptasticFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; ZiptasticSDK/1.0)';
    ...
    public static function call(ZiptasticContext $ctx, string $fullurl, array $fetchdef): array
    {
