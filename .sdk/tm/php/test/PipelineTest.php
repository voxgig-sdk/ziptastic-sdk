...
{
    private static function utility(): ZiptasticUtility
    {
        return new ZiptasticUtility();
    }
    ...
    private static function ctx(array $over = []): ZiptasticContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new ZiptasticContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new ZiptasticOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof ZiptasticError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new ZiptasticOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = ZiptasticMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new ZiptasticOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = ZiptasticMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new ZiptasticOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = ZiptasticMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new ZiptasticSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = ZiptasticMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new ZiptasticResponse([]),
            'result' => new ZiptasticResult([]),
        ]);
        [, $err] = ZiptasticMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new ZiptasticSpec([]),
            'response' => null,
            'result' => new ZiptasticResult([]),
        ]);
        [, $err] = ZiptasticMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new ZiptasticSpec(['step' => 's']),
            'response' => new ZiptasticResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new ZiptasticResult([]),
        ]);
        [, $err] = ZiptasticMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new ZiptasticSpec(['step' => 's']),
            'response' => new ZiptasticResponse(self::resp(200, ['v' => 1])),
            'result' => new ZiptasticResult([]),
        ]);
        [, $err] = ZiptasticMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new ZiptasticSpec(['step' => 's']),
            'response' => new ZiptasticResponse(self::resp(200, ['v' => 2])),
            'result' => new ZiptasticResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        ZiptasticMakeResponse::call($ctx);
    ...
    {
        $preset = new ZiptasticResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new ZiptasticSpec([]),
            'response' => new ZiptasticResponse([]),
            'result' => new ZiptasticResult([]),
        ...
        [$got, $err] = ZiptasticMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new ZiptasticResult([])]);
        [, $err] = ZiptasticMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new ZiptasticSpec([]), 'result' => null]);
        [, $err] = ZiptasticMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new ZiptasticSpec(['step' => 's']),
            'result' => new ZiptasticResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new ZiptasticOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = ZiptasticMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new ZiptasticSpec(['step' => 's']),
            'result' => new ZiptasticResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new ZiptasticOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = ZiptasticMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new ZiptasticResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new ZiptasticSpec([]),
            'result' => new ZiptasticResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = ZiptasticMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = ZiptasticMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new ZiptasticError('boom', 'boom');
        $utility->fetcher = function (ZiptasticContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new ZiptasticSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = ZiptasticMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (ZiptasticContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = ZiptasticMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(ZiptasticResponse::class, $response);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (ZiptasticContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new ZiptasticSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = ZiptasticMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new ZiptasticResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new ZiptasticSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = ZiptasticMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = ZiptasticMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = ZiptasticMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new ZiptasticResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, ZiptasticDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new ZiptasticResult(['ok' => false])]);
        $this->expectException(ZiptasticError::class);
        ZiptasticDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new ZiptasticResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', ZiptasticMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        ZiptasticMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new ZiptasticBaseFeature();
        $b = new ZiptasticBaseFeature();
        ZiptasticFeatureAdd::call($ctx, $a);
        ZiptasticFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): ZiptasticBaseFeature
    {
        $f = new ZiptasticBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        ZiptasticFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): ZiptasticContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new ZiptasticSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = ZiptasticPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new ZiptasticResponse(['headers' => null]),
            'result' => new ZiptasticResult([]),
        ]);
        ZiptasticResultHeaders::call($ctx);
