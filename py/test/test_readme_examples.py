# Ziptastic SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions ZiptasticSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both ZiptasticSDK(...) and ZiptasticSDK.test(...) become
#      ZiptasticSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "ziptastic_sdk"
_SDK_CLASS = "ZiptasticSDK"
