# Ziptastic Python SDK



The Python SDK for the Ziptastic API — an entity-oriented client following Pythonic conventions.

The SDK exposes the API as capitalised, semantic **Entities** — for example `client.GetLocationByZipcode()` — each
...
release tag (`py/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/ziptastic-sdk/releases)) or
...
```
py/
├── ziptastic_sdk.py         -- Main SDK module
