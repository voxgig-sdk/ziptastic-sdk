...
from ziptastic_sdk.ziptastic_types import (
...
class GetLocationByZipcodeEntity:
    ...
    def data_get(self) -> GetLocationByZipcode:
    ...
    def match_get(self) -> GetLocationByZipcode:
    ...
    def load(self, reqmatch=None, ctrl=None) -> GetLocationByZipcode:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.GetLocationByZipcode().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
