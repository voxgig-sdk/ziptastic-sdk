...
from ziptastic_sdk.core.helpers import get_ctx_prop, to_map
...
class ZiptasticContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(sp, ZiptasticSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, ZiptasticResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, ZiptasticResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return ZiptasticError(code, msg, self)
