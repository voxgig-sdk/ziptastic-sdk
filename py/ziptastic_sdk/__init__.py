...
from ziptastic_sdk.utility import register

# Load features
from ziptastic_sdk.feature.base_feature import ZiptasticBaseFeature
from ziptastic_sdk.features import _has_feature, _make_feature
...
class ZiptasticSDK:
    ...
    def get_utility(self):
        return ZiptasticUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("ZiptasticSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def GetLocationByZipcode(self, data=None) -> "GetLocationByZipcodeEntity":
        ...
        from ziptastic_sdk.entity.get_location_by_zipcode_entity import GetLocationByZipcodeEntity
