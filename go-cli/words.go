...
func registerSDKWords(r *eng.Registry, client *sdk.ZiptasticSDK) {
...
func runOp(client *sdk.ZiptasticSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
