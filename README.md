...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/ziptastic` | `npm install @voxgig-sdk/ziptastic` |
| Python | `voxgig-sdk-ziptastic` | `pip install voxgig-sdk-ziptastic` |
| PHP | `voxgig-sdk/ziptastic` | `composer require voxgig-sdk/ziptastic` |
| Golang | `github.com/voxgig-sdk/ziptastic-sdk/go` | `go get github.com/voxgig-sdk/ziptastic-sdk/go` |
| Ruby | `voxgig-sdk-ziptastic` | `gem install voxgig-sdk-ziptastic` |
| Lua | `voxgig-sdk-ziptastic` | `luarocks install voxgig-sdk-ziptastic` |
