...
function envOverride(m) {
    if ('TRUE' === process.env.ZIPTASTIC_TEST_LIVE ||
        'TRUE' === process.env.ZIPTASTIC_TEST_OVERRIDE) {
    ...
    m.ZIPTASTIC_TEST_EXPLAIN = process.env.ZIPTASTIC_TEST_EXPLAIN || m.ZIPTASTIC_TEST_EXPLAIN;
    return m;
}
