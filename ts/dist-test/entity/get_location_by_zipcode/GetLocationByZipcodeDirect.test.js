...
(0, node_test_1.describe)('GetLocationByZipcodeDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.ZiptasticSDK({
...
function directSetup(mockres) {
    ...
    const client = new __1.ZiptasticSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=GetLocationByZipcodeDirect.test.js.map