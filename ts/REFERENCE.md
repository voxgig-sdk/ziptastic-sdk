# Ziptastic TypeScript SDK Reference

Complete API reference for the Ziptastic TypeScript SDK.
...
```ts
new ZiptasticSDK(options?: object)
```
...
#### `ZiptasticSDK.test(testopts?, sdkopts?)`
...
**Returns:** `ZiptasticSDK` instance in test mode.


### Instance Methods

#### `GetLocationByZipcode(data?: object)`

Create a new `GetLocationByZipcode` entity instance.
...
**Returns:** `GetLocationByZipcodeEntity` instance.
...
Return the parent `ZiptasticSDK` instance.
