...
function GetLocationByZipcodeEntity:mark_deleted()
  self._deleted = true
end


function GetLocationByZipcodeEntity:deleted()
...
function GetLocationByZipcodeEntity:stream(action, args, callopts)
