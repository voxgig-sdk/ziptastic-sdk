...
local ZiptasticSDK = {}
ZiptasticSDK.__index = ZiptasticSDK
...
ZiptasticSDK._make_feature = _make_feature


function ZiptasticSDK.new(options)
  local self = setmetatable({}, ZiptasticSDK)
  self.mode = "live"
  self.features = {}
  self.options = nil
...
function ZiptasticSDK:options_map()
...
function ZiptasticSDK:get_utility()
  return Utility.copy(self._utility)
end


function ZiptasticSDK:get_root_ctx()
  return self._rootctx
end


function ZiptasticSDK:prepare(fetchargs)
...
function ZiptasticSDK:direct(fetchargs)
...
-- by passing it.
function ZiptasticSDK:_raw_request(fetchargs)
  local utility = self._utility
...
function ZiptasticSDK:graphql(query, variables, ctrl)
  ...
  if type(errors) == "table" and 0 < #errors then
    ...
    res.ok = false
    res.err = "ZiptasticSDK: graphql: " .. msg
    res.graphql = errors
  end
...
-- Idiomatic facade: client:GetLocationByZipcode():list() / client:GetLocationByZipcode():load({ id = ... })
...
function ZiptasticSDK.test(testopts, sdkopts)
  sdkopts = sdkopts or {}
  ...
  local sdk = ZiptasticSDK.new(sdkopts)
  sdk.mode = "test"
