...
describe("GetLocationByZipcodeEntity", function()
  ...
  it("should run basic flow", function()
    ...
    assert.is_nil(err)
    local get_location_by_zipcode_ref01_data_dt0_load_result = helpers.to_map(type(get_location_by_zipcode_ref01_data_dt0_loaded) == 'table' and get_location_by_zipcode_ref01_data_dt0_loaded.data_get and get_location_by_zipcode_ref01_data_dt0_loaded:data_get() or get_location_by_zipcode_ref01_data_dt0_loaded)
    assert.is_not_nil(get_location_by_zipcode_ref01_data_dt0_load_result)
    assert.are.equal(get_location_by_zipcode_ref01_data_dt0_load_result["id"], get_location_by_zipcode_ref01_data["id"])
