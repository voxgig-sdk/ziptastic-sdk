# Ziptastic PHP SDK Reference

Complete API reference for the Ziptastic PHP SDK.
...
#### `ZiptasticSDK::test($testopts = null, $sdkopts = null)`
...
#### `GetLocationByZipcode($data = null)`
...
#### `make(): GetLocationByZipcodeEntity`
