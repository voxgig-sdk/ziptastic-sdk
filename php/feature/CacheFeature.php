...
class ZiptasticCacheFeature extends ZiptasticBaseFeature
{
    ...
    private function _through(ZiptasticContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
