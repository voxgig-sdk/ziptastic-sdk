...
// Ziptastic SDK clienttrack feature
...
class ZiptasticClienttrackFeature extends ZiptasticBaseFeature
{
    ...
    public function PostConstruct(ZiptasticContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'Ziptastic-SDK';
