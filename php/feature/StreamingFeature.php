...
// Ziptastic SDK streaming feature
...
class ZiptasticStreamingFeature extends ZiptasticBaseFeature
{
    ...
    private function _iterate(ZiptasticResult $result): \Generator
    {
    ...
    private function _streamable(ZiptasticContext $ctx): bool
    {
