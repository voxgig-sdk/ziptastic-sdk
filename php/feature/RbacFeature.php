...
class ZiptasticRbacFeature extends ZiptasticBaseFeature
{
    ...
    private function _required(ZiptasticContext $ctx): ?string
    {
    ...
    private function _reject(ZiptasticContext $ctx, string $required): void
    {
    ...
    private function _track(ZiptasticContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
