...
The PHP SDK for the Ziptastic API. Provides an entity-oriented interface using PHP conventions.
...
```php
[$result, $err] = $client->GetLocationByZipcode(null)->load(["id" => "example_id"], null);
...
[$result, $err] = $client->Ziptastic(null)->load(
    ["id" => "test01"], null
);
