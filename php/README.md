...
The PHP SDK for the Ziptastic API — an entity-oriented client using PHP conventions.
...
```php
require_once 'ziptastic_sdk.php';
$client = new ZiptasticSDK($options);
```
...
```
php/
├── ziptastic_sdk.php          -- Main SDK class
...
The main class (`ziptastic_sdk.php`) exports the SDK class
