...
// Ziptastic SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (ZiptasticSDK::test)
...
{
    private const SDK_CLASS = 'ZiptasticSDK';
    ...
    private const SDK_BASE = 'ziptastic_sdk';
