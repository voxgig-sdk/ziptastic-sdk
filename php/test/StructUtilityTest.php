...
// Ziptastic SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = ZiptasticOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(ZiptasticOmni::structfix($now, Struct::undef()))
                        !== json_encode(ZiptasticOmni::structfix($val, Struct::undef()))) {
