...
class ZiptasticTestRunner
{
    ...
    {
        $live = self::getenv('ZIPTASTIC_TEST_LIVE');
        $override = self::getenv('ZIPTASTIC_TEST_OVERRIDE');
        ...
        $explain = self::getenv('ZIPTASTIC_TEST_EXPLAIN');
...
class_alias('ZiptasticTestRunner', 'Runner');
class_alias('ZiptasticHelpers', 'Helpers');
