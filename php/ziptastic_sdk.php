...
class ZiptasticSDK
{
    ...
    public function __construct(array $options = [])
    {
        ...
        $feature_opts = ZiptasticHelpers::to_map(Struct::getprop($this->options, "feature"));
        if ($feature_opts) {
            $featureorder = Struct::getpath($this->options, "__derived__.featureorder");
            if (is_array($featureorder)) {
                foreach ($featureorder as $fname) {
                    $fopts = ZiptasticHelpers::to_map($feature_opts[$fname] ?? null);
                    if ($fopts && isset($fopts["active"]) && $fopts["active"] === true) {
                        ...
                        if (!ZiptasticFeatures::has_feature($fname)) {
                        ...
                        ($utility->feature_add)($this->_rootctx, ZiptasticFeatures::make_feature($fname));
                    }
                }
            }
        }
    ...
    {
        return ZiptasticUtility::copy($this->_utility);
    }
    ...
    public function prepare(array $fetchargs = []): mixed
    {
        ...
        $ctrl = ZiptasticHelpers::to_map(Struct::getprop($fetchargs, "ctrl")) ?? [];
        ...
        $params = ZiptasticHelpers::to_map(Struct::getprop($fetchargs, "params")) ?? [];
        $query = ZiptasticHelpers::to_map(Struct::getprop($fetchargs, "query")) ?? [];
    ...
    private function op_denied(string $op): array
    {
        ...
        return [
            "ok" => false,
            "err" => new ZiptasticError($op . "_allow",
                "ZiptasticSDK: " . $op . ": operation not allowed by" .
    ...
    private function raw_request(array $fetchargs = []): mixed
    {
        ...
        if (is_array($fetched)) {
            $status = ZiptasticHelpers::to_int(Struct::getprop($fetched, "status"));
    ...
    public function graphql(string $query, ?array $variables = null, ?array $ctrl = null): mixed
    {
        ...
        if (is_array($errors) && 0 < count($errors)) {
            ...
            $res["ok"] = false;
            $res["err"] = new ZiptasticError("graphql_error",
                "ZiptasticSDK: graphql: " . $msg);
            $res["graphql"] = $errors;
        }
    ...
    public function GetLocationByZipcode($data = null)
    {
        ...
        if ($data === null) {
            if ($this->_get_location_by_zipcode === null) {
                $this->_get_location_by_zipcode = new GetLocationByZipcodeEntity($this, null);
            }
            return $this->_get_location_by_zipcode;
        }
        return new GetLocationByZipcodeEntity($this, $data);
    }
